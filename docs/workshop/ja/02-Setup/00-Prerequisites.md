...
1. GitHubプロフィールに[Build Your Own Advanced AI Copilot with PostgreSQL](http://aka.ms/pg-invoice-pilot-repo/)リポジトリの個人用フォーク（コピー）。このリポジトリには、後でワークショップを再現するために必要なすべての資料が含まれています。
