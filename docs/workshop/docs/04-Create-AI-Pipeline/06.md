...
- Upload the `Statement_of_Work_Lucerne_Publishing_Invoice_Pilot_20241201.pdf` present in the directory `data/sample_docs/Exercise_2_Load_SOW_Invoices/`.
...
- Upload the `Statement_of_Work_VanArsdel_Ltd_Invoice_Pilot_20231001.pdf` present in the directory `data/sample_docs/Exercise3_Load_Bad_SOWandINV/`.
