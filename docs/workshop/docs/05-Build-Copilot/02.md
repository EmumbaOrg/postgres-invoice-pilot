...
=== "2. Vectorize Query"
    ...
    ???+ info "Generate Embeddings"
        ...
        The below `__create_query_embeddings` function in the _Invoice Pilot API_ uses the LangChain [AzureOpenAIEmbeddings](https://python.langchain.com/docs/integrations/text_embedding/azureopenai/) class to generate embeddings for the provided _user query_.
