...
(1, 'Project Deliverables', 'Milestone Name Deliverables Amount Due Date 1 Monitoring Monitoring of resources $8,600.00 2024-12-08 2 Resource Scaling Implementation of automated scaling $7,000.00 2024-12-08 3 Cost Management Cost Management Implementation $7,000.00 2024-12-22 4 Maintenance Practices Maintenance & troubleshooting practice $10,500.00 2024-12-27 5 App Troubleshooting Identify Azure application issues $2,000.00 2024-12-27 5 App Troubleshooting Resolution of Azure application issues $3,500.00 2025-01-30 5 App Troubleshooting Implementation of app monitoring $5,000.00 2025-01-30 Total $43,600.00 Signatures (Adatum Corporation - Elizabeth Moore) (Invoice Pilot - Sora Kim)', 2),
...
(2, 'Schedules', 'Project kick-off: November 12, 2024 - DevOps Strategy & Planning: November 20, 2024 - CI/CD Pipeline Implementation: November 27, 2024 - Infrastructure as Code (IaC): December 15, 2024 - Security, Monitoring & Optimization: December 31, 2024', 1),
...
(2, 'Project Deliverables', 'Milestone Name Deliverables Amount Due Date 1 DevOps Strategy & Planning DevOps Roadmap & Report $10,000.00 2024-12-20 2 CI/CD Pipeline Implementation Deployment Pipeline, Version Control Implementation, Branching Strategy $20,000.00 2024-12-27 3 Infrastructure as Code (IaC) Infrastructure as Code Implementation, Containerization, Orchestration Setup $15,000.00 2025-01-14 4 Security, Monitoring & Optimization Security & Compliance Integration, Monitoring & Logging Setup, Performance Optimization $15,000.00 2025-01-30 Total $60,000.00 Signatures (Trey Research - Serena Davis) (Invoice Pilot - Sora Kim)', 2);
...
(5,'Resolution of Azure application issues',3500.00,'Completed', '2024-12-31'),
...
(7,'Deployment Pipeline, Version Control Implementation, Branching Strategy Implementation',20000.00,'pending','2024-11-27'),
(8,'Infrastructure as Code Implementation, Containerization & Orchestration Setup',15000.00,'pending','2024-12-15'),
(9,'Security & Compliance Integration, Monitoring & Logging Setup, Performance Optimization',15000.00,'pending','2024-12-31');
