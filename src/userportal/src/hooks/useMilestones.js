...
import { getMilestones, getMilestone, createMilestone, updateMilestone, deleteMilestone } from '../services/milestones.service';
...
export const useMilestones = ({ sowId = -1, skip = 0, limit = 10, sortBy = '' } = {}) => {
  return useQuery({
    ...
    queryFn: () => getMilestones({ sowId, skip, limit, sortBy }),
    staleTime: 30_000,
  });
};
